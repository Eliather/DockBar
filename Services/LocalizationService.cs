...
public static class LocalizationService
{
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
    {
        ["es"] = new Dictionary<string, string>
        {
            ...
            ["AddLink_Subtitle"] = "Agrega una ruta, comando o URI y asígnale un nombre opcional para mostrarlo en el dock.",
            ...
            ["Store_Subtitle"] = "Explora las aplicaciones instaladas y agrégalas al dock con su ícono del sistema.",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["AddLink_Subtitle"] = "Add a path, command, or URI and give it an optional label for the dock.",
            ...
            ["Store_Subtitle"] = "Browse installed apps and add them to the dock with their system icon.",
